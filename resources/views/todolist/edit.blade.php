        ...
        <div class="row">
            <div class="col-12">
                <div class="form-group">
                    ...
                    <input type="text" name="title" id="title" class="form-control required"
                        placeholder="Enter task title" required value="{{ 'Judul Task' }}">
            ...
            <div class="col-12 mt-2">
                <div class="form-group">
                    ...
                    <textarea name="description" id="description" class="form-control" placeholder="Enter task description here" required>{{ 'Deskripsi Task' }}</textarea>
                    <div class="invalid-feedback">
            ...
            <div class="col-6 mt-2">
                <div class="form-group">
                    <label for="deadline" class="mb-2 fw-bold" style="font-size: small">Task Deadline</label>
                    <input name="deadline" type="datetime-local" id="deadline" class="form-control"
                        placeholder="Select deadline date" value="{{ '2025-04-20T09:00:00' }}" required>
                    <div class="invalid-feedback">
            ...
            <div class="col-6 mt-2">
                <div class="form-group">
                    ...
                    <select name="priority  " id="priority  " class="form-select py-2" required>
                        ...
                        <option value="0" {{ 1 == 0 ? 'selected' : '' }}>Low</option>
                        <option value="1" {{ 1 == 1 ? 'selected' : '' }}>Normal</option>
                        <option value="2" {{ 1 == 2 ? 'selected' : '' }}>High</option>
                    </select>
                    <div class="invalid-feedback">
